      ...
      >
        ...
        <div
          ...
          style={{
            ...
            width: '500px',
            height: '500px',
            background: 'radial-gradient(circle, rgba(217, 162, 153, 0.2) 0%, rgba(217, 162, 153, 0.05) 50%, transparent 70%)',
            borderRadius: '50%',
            filter: 'blur(40px)',
          }}
        />
        <div
          ...
          style={{
            ...
            width: '400px',
            height: '400px',
            background: 'radial-gradient(circle, rgba(240, 228, 211, 0.6) 0%, rgba(240, 228, 211, 0.2) 50%, transparent 70%)',
            borderRadius: '50%',
            filter: 'blur(30px)',
        ...
        <div
          ...
          style={{
            ...
            width: '200px',
            height: '200px',
            background: 'radial-gradient(circle, rgba(220, 197, 178, 0.3) 0%, transparent 70%)',
            borderRadius: '50%',
            filter: 'blur(20px)',
        ...
        >
          ...
          >
            ...
            >
              <span
                className="animate-landing-pulse"
                style={{
                  width: '8px',
                  height: '8px',
                  background: '#D9A299',
              ...
              />
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#B8847A' }}>
          ...
          >
            ...
            <span
              style={{
                background: 'linear-gradient(135deg, #D9A299 0%, #B8847A 50%, #C8967F 100%)',
          ...
          >
            Voca-Coach empowers therapists, executives, and students to master communication
            through AI-driven feedback, stress management, and personalized coaching.
          </p>
          ...
          >
            <Link
              ...
              style={{
                ...
                fontSize: '17px',
                fontWeight: '600',
                boxShadow: '0 8px 30px rgba(217, 162, 153, 0.4)',
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 40px rgba(217, 162, 153, 0.5)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 8px 30px rgba(217, 162, 153, 0.4)';
              }}
            >
              Start Free Trial
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background = 'rgba(217, 162, 153, 0.1)';
              }}
              onMouseLeave={(e) => {
          ...
          >
            {[
              { icon: '🎙️', title: 'Voice Analysis', desc: 'Real-time feedback' },
              { icon: '📊', title: 'Biomarkers', desc: 'Track vocal health' },
              { icon: '🧘', title: 'De-escalation', desc: 'Stress management' },
              { icon: '💬', title: 'Practice', desc: 'AI conversations' },
            ].map((item, i) => (
              <div
                key={i}
                style={{
              ...
              >
                ...
                <div style={{ fontWeight: '600', color: '#3D3D3D', marginBottom: '4px' }}>{item.title}</div>
                <div style={{ fontSize: '14px', color: '#6B6B6B' }}>{item.desc}</div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            ...
            <div style={{ gridColumn: 'span 1' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                ...
                <span style={{ fontSize: '20px', fontWeight: '700', color: 'white' }}>Voca-Coach</span>
              </div>
              <p style={{ fontSize: '15px', color: '#9CA3AF', lineHeight: '1.7', marginBottom: '24px' }}>
                AI-powered vocal coaching for better communication and wellbeing.
              </p>
              {/* Social Icons */}
              <div style={{ display: 'flex', gap: '12px' }}>
                {[
                  ...
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = '#D9A299';
                    }}
                    onMouseLeave={(e) => {
            ...
            {/* Product Column */}
            <div>
              <h4 style={{ color: 'white', fontWeight: '600', marginBottom: '20px', fontSize: '15px' }}>Product</h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {['De-escalation', 'Biomarkers', 'Journal', 'Practice Mode', 'Therapy'].map((item) => (
                  <Link
                    key={item}
                    href={`/${item.toLowerCase().replace(' ', '-')}`}
                    style={{ color: '#9CA3AF', fontSize: '15px', transition: 'color 0.2s ease' }}
            ...
            {/* Company Column */}
            <div>
              <h4 style={{ color: 'white', fontWeight: '600', marginBottom: '20px', fontSize: '15px' }}>Company</h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {/* Resources Column */}
            <div>
              <h4 style={{ color: 'white', fontWeight: '600', marginBottom: '20px', fontSize: '15px' }}>Resources</h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {['Help Center', 'Community', 'Guides', 'API Docs', 'Webinars'].map((item) => (
                  <a
                    key={item}
                    href="#"
                    style={{ color: '#9CA3AF', fontSize: '15px', transition: 'color 0.2s ease' }}
            ...
            {/* Legal Column */}
            <div>
              <h4 style={{ color: 'white', fontWeight: '600', marginBottom: '20px', fontSize: '15px' }}>Legal</h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'HIPAA Compliance', 'Security'].map((item) => (
                  <a
                    key={item}
                    href="#"
                    style={{ color: '#9CA3AF', fontSize: '15px', transition: 'color 0.2s ease' }}
          ...
          >
            <p style={{ color: '#6B7280', fontSize: '14px' }}>
              © {new Date().getFullYear()} Voca-Coach. All rights reserved.
            </p>
            <div style={{ display: 'flex', gap: '24px' }}>
              <a href="#" style={{ color: '#6B7280', fontSize: '14px' }}>Privacy</a>
              <a href="#" style={{ color: '#6B7280', fontSize: '14px' }}>Terms</a>
              <a href="#" style={{ color: '#6B7280', fontSize: '14px' }}>Cookies</a>
            </div>
          </div>
        </div>
      </footer>
